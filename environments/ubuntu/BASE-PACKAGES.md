...
Layer 4 = .venv / package.json 같은 Project dependency
```
...
- [Layer 0 — OS Prerequisites](#layer-0)
- [Layer 1 — Common Required Base](#layer-1)
- [Layer 1B — Recommended Productivity](#layer-1b)
- [Layer 2 — External/Common Developer CLI](#layer-2)
- [Layer 3 — Mission / Shared Runtime](#layer-3)
- [Layer 4 — Project Dependencies](#layer-4)
- [통합 Bootstrap](#bootstrap)
