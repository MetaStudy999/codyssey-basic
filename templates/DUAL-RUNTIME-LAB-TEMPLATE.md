# <MISSION-ID> Runtime / Optional Docker Labs

## 목적

이 문서는 공식 Mission/Evaluation을 바꾸지 않고, 현재 Mission의 **Primary Runtime + Secondary Platform Check + Optional Docker Lab**을 정리하는 보조 실습 문서입니다.

## Runtime Profile

- Primary Mission Runtime: `<PROFILE>`
- Secondary Platform Check: `<PROFILE>`
...
## Lab B — Secondary Platform Check (권장)
