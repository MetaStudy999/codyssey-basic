...
- [Visual Learning Backlog](./visual-learning-backlog.md)
  - 용어별 `Cover → One-line → Where → Relation → Mini Check → Gate → Summary` 형식
...
00 Mission Index
  ↓
10 Level 0 → 29 individual prerequisite term files ✅
  ↓
...
Visual Learning은 별도 Backlog로 이동했으며 현재 Critical Path가 아니다.
